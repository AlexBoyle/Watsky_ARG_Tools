(() => { 
	...
	let postcards = [
	// line 33
		{id: 01, st: 'AZ', dots: [6]	, index: 3, color: "red"	, zip: "-----", recipNum: 0},
		{id: 02, st: 'CA', dots: [7]	, index: 0, color: "green"	, zip: "-----", recipNum: 0},
		{id: 03, st: 'CO', dots: [9]	, index: 4, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 04, st: 'CO', dots: [9]	, index: 0, color: "green"	, zip: "-----", recipNum: 0},
		{id: 05, st: 'DC', dots: [8]	, index: 2, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 06, st: 'FL', dots: [8,4]	, index: 2, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 07, st: 'FL', dots: [9]	, index: 0, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 08, st: 'FL', dots: [7]	, index: 1, color: "green"	, zip: "-----", recipNum: 0},
		{id: 09, st: 'IL', dots: [6,4]	, index: 0, color: "green"	, zip: "-----", recipNum: 0},
		{id: 10, st: 'IL', dots: [13]	, index: 2, color: "red"	, zip: "-----", recipNum: 0},
		{id: 11, st: 'IN', dots: [12]	, index: 4, color: "red"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'IN', dots: [7,4]	, index: 2, color: "green"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'IN', dots: [8]	, index: 1, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 12, st: 'LA', dots: [10]	, index: 2, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 13, st: 'MA', dots: [3,5]	, index: 4, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 14, st: 'MA', dots: [6]	, index: 2, color: "red"	, zip: "-----", recipNum: 0},
		{id: 15, st: 'MI', dots: [10]	, index: 4, color: "red"	, zip: "-----", recipNum: 0},
		{id: 16, st: 'MI', dots: [6,7]	, index: 3, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 17, st: 'MI', dots: [4,6]	, index: 1, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 18, st: 'MO', dots: [7]	, index: 0, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 19, st: 'MO', dots: [11]	, index: 1, color: "red"	, zip: "-----", recipNum: 0},
		{id: 19, st: 'MO', dots: [10]	, index: 2, color: "green"	, zip: "-----", recipNum: 0},
		{id: 20, st: 'NC', dots: [6]	, index: 3, color: "green"	, zip: "-----", recipNum: 0},
		{id: 21, st: 'NM', dots: [4,5]	, index: 0, color: "green"	, zip: "-----", recipNum: 0},
		{id: 22, st: 'NV', dots: [7,4]	, index: 0, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 23, st: 'NV', dots: [4,6]	, index: 0, color: "red"	, zip: "-----", recipNum: 0},
		{id: 24, st: 'NV', dots: [5]	, index: 1, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 25, st: 'NY', dots: [6,7]	, index: 4, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 25, st: 'NY', dots: [7,5]	, index: 2, color: "red"	, zip: "-----", recipNum: 0},
		{id: 26, st: 'OH', dots: [9]	, index: 2, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 26, st: 'OK', dots: [6]	, index: 1, color: "green"	, zip: "-----", recipNum: 0},
		{id: 26, st: 'OK', dots: [9]	, index: 1, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 26, st: 'OR', dots: [7]	, index: 4, color: "blue"	, zip: "-----", recipNum: 0},
		{id: 27, st: 'TN', dots: [5,6]	, index: 1, color: "green"	, zip: "-----", recipNum: 0},
		{id: 28, st: 'TN', dots: [7]	, index: 1, color: "red"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'TX', dots: [5]	, index: 3, color: "yellow"	, zip: "-----", recipNum: 0},
		{id: 29, st: 'VA', dots: [8]	, index: 1, color: "green"	, zip: "-----", recipNum: 0},
		{id: 30, st: 'VA', dots: [10]	, index: 3, color: "red"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'WA', dots: [12,8]	, index: 3, color: "red"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'WA', dots: [6]	, index: 2, color: "green"	, zip: "-----", recipNum: 0},
		{id: 31, st: 'WI', dots: [9]	, index: 1, color: "yellow"	, zip: "-----", recipNum: 0},
